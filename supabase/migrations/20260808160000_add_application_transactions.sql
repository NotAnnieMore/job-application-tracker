...
create unique index applications_user_opportunity_unique
...
create function public.delete_application_with_opportunity(
  p_application_id uuid
)
returns boolean
language plpgsql
...
revoke execute on function public.delete_application_with_opportunity(uuid)
from public, anon;
...
grant execute on function public.delete_application_with_opportunity(uuid)
to authenticated;
